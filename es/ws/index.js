...
export class WS {
    constructor(socketUrl, option) {
        ...
        this.option = Object.assign({ onOpenAutoSendMsg: "", heartTime: 30000, heartMsg: 'ping', isReconnect: true, reconnectTime: 5000, reconnectCount: -1, openCallback: null, closeCallback: null, messageCallback: null, errorCallback: null, debug: false }, option);
        this.websocket = null;
    ...
    init() {
        ...
        this.websocket = new WebSocket(this.socketUrl, Object.assign({}, this.option.wsOptions));
